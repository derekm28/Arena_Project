...
export default ({
  ...
  const onButtonClicked = e => {
    e.preventDefault();
    Dispatch({
      type: types.SHOW_TEXT_BUTTON_CLICKED,
      payload: null
    })
  }
  const defaultSteps = [
      ...
      <TwoColumn>
        ...
        <TextColumn textOnLeft={textOnLeft}>
          <TextContent>
            ...
            <Box onClick={onButtonClicked} >
            <PrimaryButton buttonRounded={buttonRounded} as="button">
              {primaryButtonText}
            </PrimaryButton>
            </Box >
            {/* <Button className="sc-hiCibw TwoColWithSteps__PrimaryButton-sc-18tnxsj-6 ktXcRC ghhObZ" onClick={showTextButtonClicked} >
              Hello there
            </Button> */}
          </TextContent>
        </TextColumn>
