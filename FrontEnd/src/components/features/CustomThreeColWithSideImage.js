  ...
  const defaultCards = [
    {
      ...
      title: "Make a Workout Friend",
      description: textConstants.workoutfriend
    },
  ...
  return (
    <Container>
      <ThreeColumnContainer>
        ...
        <Heading>{"Make a Workout Friend"}</Heading>
        <Description>{textConstants.workoutfriend}</Description>
        <Heading>{"Find your Team"}</Heading>
        <Description>{textConstants.team}</Description>
        <Heading>{"Share Your Trophies"}</Heading>
        <Description>{textConstants.trophies}</Description>
        <Heading>{"Discover New Places & Flavors"}</Heading>
        <Description>{textConstants.workoutfriend}</Description>
        {/* <VerticalSpacer /> */}
        {/* {cards.map((card, i) => (
          <Column key={i}>
